...
1. For VLC functionality (experimental):
	...
	* Enable the HTTP Interface in VLC:
		...
		* Under ```Interface > Main interfaces > Lua```, you can set a password for the HTTP interface. Use ```password``` as a password if you don't want to change it in the code
